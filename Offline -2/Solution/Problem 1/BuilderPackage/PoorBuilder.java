...
public class PoorBuilder implements SystemBuilder{
    ...
    public PoorBuilder(String connectionType, int displayUnitCount)
    {
    ...
    public void buildProcessor() {
        ...
        Components processor = processorFactory.getProcessor("atmega");
