...
public class DeluxeBuilder implements SystemBuilder{
    ...
    public DeluxeBuilder(String connectionType, int displayUnitCount)
    {
    ...
    public void buildProcessor() {
        ...
        Components processor = processorFactory.getProcessor("raspberrypi");
    ...
    public void buildDisplay() {
        ...
        Components display = displayFactory.getDisplay("lcd");
